      ...
      <section className="relative flex flex-col items-center justify-center text-center min-h-screen px-6 pt-24 pb-16 overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold leading-tight tracking-tight text-white max-w-3xl mb-6">
          ...
          <span className="relative inline-block">
            ...
            >
              <path
                d="M1 5.5 C50 1, 100 7, 150 4 S250 1, 299 5"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "NeverMiss extracts the task, date, time, and recurrence — then confirms with you before saving.",
              ...
              },
              {
                ...
                icon: "🔔",
                title: "Get Reminded",
                desc: "Receive a push notification and hear the AI read your reminder aloud — right when you need it.",
                color: "from-[#34d399]/20 to-[#059669]/5",
                border: "border-[#34d399]/20",
                accent: "#34d399",
              },
            ].map(({ step, icon, title, desc, color, border, accent }) => (
              <div
                key={step}
                className={`relative rounded-2xl border ${border} bg-gradient-to-br ${color} backdrop-blur-sm p-6 group hover:-translate-y-1 transition-transform duration-300`}
              >
